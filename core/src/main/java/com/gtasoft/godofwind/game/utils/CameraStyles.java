...
public class CameraStyles {
    public final static int CAMERA_LOCK_ON_TARGET = 0;
    public final static int CAMERA_LERP_ON_TARGET = 1;
    public final static int CAMERA_LOCK_AVERAGE_BETWEEN_TARGET = 2;
    public final static int CAMERA_LERP_AVERAGE_BETWEEN_TARGET = 3;
    public final static int CAMERA_SEARCH_FOCAL = 4;
    public final static int CAMERA_SHAKE = 5;
